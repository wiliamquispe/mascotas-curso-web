...
$sql = "select * from atencion LEFT JOIN pets ON atencion.dniMascota = pets.dni LEFT JOIN professionals ON atencion.dniProfesional = professionals.dni where dniMascota='$codigo_pet'";
